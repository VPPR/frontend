...
import { Switch, FormControlLabel, Button, Grid, Paper, TextField, Typography, withStyles,
        ...
        return (
          <>
            ...
            >
              <Grid container>
                <FormControlLabel
        control={<Switch checked={this.state.isActive} onChange={this.changeActiveInput} />}
        ...
        /></Grid>
            ...
            <Grid item container alignContent="center">
              ...
              <Button color="primary" variant="contained" component="label">
                Upload File
                <input type="file" name="file" hidden accept=".csv" onChange={this.handleInputChange}></input>
              </Button>
              <Typography variant="body1" style={{ padding: "0.5rem" }}>
                    {this.state.file.name}
              </Typography>
