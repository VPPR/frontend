                            ...
                            <Card variant="elevation" style={{ height: "100%" }}>
                                ...
                                <CardContent>
                                    <div style={{ width: "100%", height: 250 }}>
                                        ...
                                        severity. The output is based on your recent mood scores and may vary over time.
                                        So, don't jump into conclusions quickly!
                                    </div>
                                </CardContent>
                            </Card>
                        </Grid>
                    ...
                    <Hidden only={["xs", "sm"]}>
                        <Grid item md={6}>
                            <Card variant="elevation">
                                ...
                                <CardContent>
                                    <div style={{ width: "100%", height: 250 }}>
                                        This chart is based on your PHQ-9 scores and indicates your mood variation over
                                        a period of 14 days.
                                    </div>
                                </CardContent>
                            </Card>
